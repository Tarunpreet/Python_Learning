...
while True:
    ...
    if str(soup).find("Exam (Dec.2017) Result of B.Tech")==-1 or  str(soup).find("Exam (Dec.2017) Result for B.Tech")== -1:
        print ('nhi hua')
        time.sleep(120)
        continue

    else:
        msg = 'Subject: This is Tarunpreet script talking, CHECK RESULTS!'
        fromaddr = 'tarunpreet2697@gmail.com'
        toaddrs  = ['tarunpreet2697@gmail.com','jsjeevandeepsingh23@gmail.com','karanpreets7@gmail.com']
